...
export const WebDevelopmentSection: React.FC<WebDevelopmentSectionProps> = ({
  ...
  return (
    <section className="py-20 sm:py-28 bg-[#F8FAFC] text-slate-900 relative overflow-hidden" id="website-development-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="rounded-3xl bg-slate-900 text-white p-6 sm:p-10 shadow-2xl mb-16 border border-slate-800"
        >
            ...
            <AnimatePresence mode="wait">
              ...
              {devicePreview === 'desktop' && (
                <motion.div
                  ...
                  className="w-full max-w-4xl rounded-xl bg-[#0B1026] border border-slate-700 shadow-2xl overflow-hidden"
                >
                  {/* Browser bar */}
              ...
              {devicePreview === 'tablet' && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                  className="w-[520px] rounded-2xl bg-[#0B1026] border-4 border-slate-700 shadow-2xl p-4 overflow-hidden"
                >
              ...
              {devicePreview === 'mobile' && (
                <motion.div
                  ...
                  exit={{ opacity: 0, scale: 0.95 }}
                  transition={{ duration: 0.3 }}
                  className="w-[280px] rounded-3xl bg-[#0B1026] border-4 border-slate-700 shadow-2xl p-4 overflow-hidden"
                >
                  {/* Notch */}
          ...
          <div className="mt-8 pt-6 border-t border-slate-800 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
            <div className="p-3 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-emerald-500/40 transition-colors">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-14">
          {WEB_DEV_HIGHLIGHTS.map((item, idx) => (
            <motion.div
              key={item.title}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              whileHover={{ y: -6 }}
              className="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-xl hover:border-blue-300 transition-all group"
            >
        ...
        <div className="text-center">
          <motion.button
            ...
            className="px-8 py-4 rounded-xl brand-gradient text-white font-bold text-base shadow-xl shadow-blue-600/30 transition-all inline-flex items-center gap-2.5 cursor-pointer"
            id="web-dev-cta-btn"
          >
