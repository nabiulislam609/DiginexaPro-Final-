...
export const CaseStudiesSection: React.FC<CaseStudiesSectionProps> = ({
  ...
  return (
    <section className="py-20 sm:py-28 bg-[#0B1026] text-white relative overflow-hidden" id="case-studies-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Tab Switcher for Case Studies with motion layout pill */}
          <div className="flex flex-wrap items-center justify-center gap-2 mt-8">
            {CASE_STUDIES.map((cs) => {
              const active = selectedCase === cs.id;
              return (
                <button
                  key={cs.id}
                ...
                >
                  {active && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-gradient-to-r from-blue-600 to-violet-600 rounded-xl shadow-lg -z-10"
        ...
        {/* Selected Case Study Deep Dive Card with AnimatePresence */}
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="rounded-3xl bg-[#0F1635] border border-slate-800 p-6 sm:p-10 shadow-2xl"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              {activeStudy.metrics.map((m, idx) => (
                <motion.div
                  ...
                  className="p-4 rounded-2xl bg-[#111836] border border-slate-800/90 transition-all"
                >
