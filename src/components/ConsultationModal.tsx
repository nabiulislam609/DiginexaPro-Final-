              ...
              {submitted ? (
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={handleReset}
                    className="mt-6 px-8 py-3 rounded-xl brand-gradient text-white font-bold text-xs sm:text-sm shadow-md cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-700 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400 transition-colors"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold text-slate-300 mb-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-700 text-sm text-white focus:outline-none focus:border-cyan-400 transition-colors"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-2 rounded-xl bg-slate-900 border border-slate-700 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400 transition-colors"
                    ></textarea>
                  </div>
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={loading}
                    className="w-full py-3.5 rounded-xl brand-gradient text-white text-sm font-bold shadow-lg shadow-blue-600/30 hover:shadow-cyan-500/30 transition-all flex items-center justify-center gap-2 mt-4 cursor-pointer"
                  >
                    {loading ? (
